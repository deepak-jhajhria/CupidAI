...
const IdentityHub = () => {
    return (
        <div className="py-20 sm:py-24 md:py-32 lg:py-40 overflow-x-clip relative mt-64">
            <div className="flex flex-col w-full justify-center items-center max-w-[691px] px-3 mx-auto relative z-10">
                <h2 className=" text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-semibold text-center leading-13">Be part of the future of <br /> IdentityHub</h2>
