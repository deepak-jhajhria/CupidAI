        ...
        <>
            <div className="relative lg:h-[810px] sm:h-[700px] h-[610px] overflow-hidden">
                ...
                <div className="flex flex-col w-full justify-center items-center max-w-[691px] px-3 mx-auto relative z-10 mt-16 pt-1.5">
                    <h2 className=" text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-semibold text-center md:leading-13">Unleash <span className="bg-gradient-to-r to-orange-red from-15% from-blue text-transparent bg-clip-text">Creativity</span>, Effortlessly</h2>
