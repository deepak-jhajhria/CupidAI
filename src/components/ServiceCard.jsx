    ...
    return (
        <div className='py-32 bg-black bg-bg_gradient'>
            <div className='max-w-[966px] px-3  mx-auto '>
                ...
                <p className=' font-medium text-dark-gray text-xxl text-center mx-auto leading-7 lg:max-w-[500px] pt-5'>Tweak anything and everything to ensure fits your business, not the other way around.</p>
