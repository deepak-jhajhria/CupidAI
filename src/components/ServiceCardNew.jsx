    ...
    return (
        <div id='service' className='py-10 lg:pt-24 lg:pb-20 md:py-16 bg-bg_gradient'>
            <div className='max-w-[966px] px-3  mx-auto '>
                ...
                <p className=' font-medium text-gray sm:text-xxl text-xl  text-center mx-auto leading-7 lg:max-w-[424px] md:pt-3 pt-2 lg:pt-5'>Tweak anything and everything to ensure fits your business, not the other way around.</p>
                <div className='flex flex-row flex-wrap pt-3 -mx-3 sm:pt-5 lg:pt-11'>
